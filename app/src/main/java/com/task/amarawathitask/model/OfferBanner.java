...
public class OfferBanner {
    ...
    public OfferBanner(String id, String image, String category_id, String title, String tag, String content, String promocode, String status, String slider_banner, String offer_banner, String trending_banner, Object created_at, Object updated_at) {
        this.id = id;
        this.image = image;
